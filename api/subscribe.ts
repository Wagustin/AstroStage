...
export default async function handler(req: any, res: any) {
  ...
  // Validate req.body exists and is an object to prevent destructuring errors
  ...
  // Validate email is a string before calling string methods to prevent TypeErrors
