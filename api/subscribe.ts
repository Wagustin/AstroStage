...
export default async function handler(req: any, res: any) {
  ...
  // 🛡️ Sentinel: Validate req.body exists and is an object to prevent TypeErrors
  ...
  // 🛡️ Sentinel: Ensure email is a string before calling string methods to prevent DoS
