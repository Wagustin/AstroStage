...
export class App implements AfterViewInit {
  ...
  initCursorTrail() {
    ...
    let expTopDoc = expSection ? expSection.getBoundingClientRect().top + window.scrollY : 0;
    ...
    const updateExpPos = () => {
      ...
      if (expSection) {
        expTopDoc = expSection.getBoundingClientRect().top + window.scrollY;
      }
    };
    ...
    window.addEventListener('mousemove', (e) => {
      ...
      if (expSection && mouseY + window.scrollY < expTopDoc) {
