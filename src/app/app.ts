...
export class App implements AfterViewInit {
  ...
  initCursorTrail() {
    ...
    // Cache element reference and page-relative position to avoid layout thrashing in mousemove listener
    ...
    const updateExpSectionTop = () => {
      ...
      if (expSection) {
        ...
        expSectionTop = rect.top + window.scrollY;
      }
    };
