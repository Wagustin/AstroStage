...
export class App implements AfterViewInit {
  ...
  initCursorTrail() {
    ...
    // Cache element and layout calculations to prevent layout thrashing in mousemove handler
    let expSection = document.getElementById('experiencia');
    let expTop: number | null = null;
    ...
    updateExpTop();
    window.addEventListener('resize', updateExpTop);
    window.addEventListener('scroll', updateExpTop, { passive: true });
