...
export class App implements AfterViewInit {
  ...
  initCursorTrail() {
    ...
    // Cache element and top position outside listener to prevent DOM querying & layout thrashing on mousemove
    const expSection = document.getElementById('experiencia');
    let expSectionTop = expSection ? expSection.getBoundingClientRect().top : 0;
