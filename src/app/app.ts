...
export class App implements AfterViewInit {
  ...
  initCursorTrail() {
    ...
    const updateExpTop = () => {
      ...
      if (expSection) {
        expTop = expSection.getBoundingClientRect().top + window.scrollY;
      }
    };
    ...
    window.addEventListener('mousemove', (e) => {
      ...
      // using cached expTop offset to avoid layout thrashing in mousemove listener
      if (mouseY < expTop - window.scrollY) {
        return;
      }
