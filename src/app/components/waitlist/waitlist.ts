    ...
    if (this.waitlistForm.valid) {
      ...
      this.http.post('/api/subscribe', { email }).subscribe({
        ...
        error: (err) => {
          ...
          // Security: Prevent information leakage by returning a generic user error message.
          // Omit internal backend error details, stack traces, or exception messages from the UI.
          this.errorMessage =
